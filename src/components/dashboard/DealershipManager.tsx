...
type Enquiry = { id: string; name: string; email: string; phone: string; businessName: string; address: string; district: string; dealershipType: string; experience: string; message: string; status: string; adminNotes: string; createdAt: string };
